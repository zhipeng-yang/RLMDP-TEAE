...
import gym
import pandas as pd
from Uniform.Algorithm import DDQN as METHOD
    ...
    for episode in range(EPISODE):
        ...
        for step in range(STEP):
            ...
            pd_data = pd.DataFrame({
                ...
                'Reward': Reward,
                'Algorithm': algorithm, })
            pd_data.to_csv('E:/DESKTOP/TEAE/code/DDQN/Uniform/data/train/' + ENV + '.csv')
        ...
        if episode % eval_interval == 0:
            ...
            pd_data2 = pd.DataFrame({
                ...
                'Reward': Mean_Reward,
                'Score': Score, })
            pd_data2.to_csv('E:/DESKTOP/TEAE/code/DDQN/Uniform/data/test/' + ENV + '.csv')




if __name__ == '__main__':
    algorithm = "DDQN_Uniform"
    EPISODE = 400  # 迭代周期数
    STEP = 5000  # 每个周期迭代时间步
    params_interval = 1
    eval_interval = 2
