...
import pandas as pd
import torch
from PER_TEAE.Algorithm import DQN as METHOD
    ...
    for episode in range(EPISODE):
        ...
        for step in range(STEP):
            ...
            pd_data = pd.DataFrame({
                ...
                'Reward': Reward,
                'Algorithm': algorithm, })
            pd_data.to_csv('E:/DESKTOP/TEAE/code/DQN/PER_TEAE/data/train/' + ENV + '.csv')
        ...
        if episode % eval_interval == 0:
            ...
            pd_data2 = pd.DataFrame({
                ...
                'Reward': Mean_Reward,
                'Score': Score, })
            pd_data2.to_csv('E:/DESKTOP/TEAE/code/DQN/PER_TEAE/data/test/' + ENV + '.csv')


print('>>>>>>>>>>>>The Program Has Finished Running>>>>>>>>>>>>')

if __name__ == '__main__':
    algorithm = "DQN_PER_TEAE"
    EPISODE = 400  # 迭代周期数
    STEP = 5000  # 每个周期迭代时间步
    params_interval = 1
    eval_interval = 2
